    ...
    public ArrayList<DirectedGraphNode> topSort(ArrayList<DirectedGraphNode> graph) {
        ...
        while (!nodeQueue.isEmpty()) {
            ...
            for (DirectedGraphNode neighbor : curNode.neighbors) {
                ...
                1. 都是入度为1的节点，比如A和B，它们的入度是来自那些天生入度为零的节点，还是来自那些天生入度大于零的节点，决定了A和B的地位高下有别
                2. 一个天生入度为零的节点，比如C，所直接连接的节点中，有的可能入度为1，有的可能入度很高，后者的地位依然是较低的，不因它与C相连而受到决定性的高地位。当然它在我们的处理过程中会被优先地 -1 入度。在此之后，就看其他因素了 */
