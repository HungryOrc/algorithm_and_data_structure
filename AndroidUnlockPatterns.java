...
2. All the keys must be distinct. 即一个key不能走两次，但被走过的key，之后的步骤可以越过它的上空
...
9和2, 9和4, 8和1, 8和3这样的飞跃，中间不算越过任何格子，即认为它们之间是相邻的
4. The order of keys used matters.

图示: https://leetcode.com/problems/android-unlock-patterns/
...
// Java DFS solution with clear explanations and optimization
